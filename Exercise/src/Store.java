...
public class Store {
    ...
    public ArrayList<Action> searchActionByDate(Date date){
        ArrayList<Action> actionsDate = new ArrayList<Action>();
        for(int i = 0; i < actions.size(); i++)
            if(actions.get(i).getDate() == date)
                actionsDate.add(actions.get(i));
